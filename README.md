...
### Static view
In the diagram we have decomposed the application into key components:
...
Here you can find the diagram: ![Component diagram](docs/architecture/static-view/component-diagram.png), and here is the code for PlantUML: ![Code for the diagram](docs/architecture/static-view/component-diagram.txt)
...
### Dynamic view
In the scenario an anonymous user converts to an authenticated session, bringing along all their previous messages and context. It exercises the following components and steps:
...
4. Web API returns a JSON response back to the client: 
sh { "response": "You have successfully logged in" } 
...
Here you can find the diagram: ![Sequence diagram](docs/architecture/dynamic-view/sequence-diagram.png), and here is the code for PlantUML: ![Code for the diagram](docs/architecture/dynamic-view/sequence-diagram.txt)
...
Here you can find the diagram: ![Deployment diagram](docs/architecture/deployment-view/deployment-diagram.png), and here is the code for PlantUML: ![Code for the diagram](docs/architecture/deployment-view/deployment-diagram.txt)
